    ...
    <div>
        ...
        <div class="ms-doc">
            ...
            <article>
                ...
                <el-row :gutter="20">
                    <el-col :span="6" class="span_l">设备连接类型：</el-col>
                    <el-col :span="16" class="span_r">{{item.LinkType | formatLinkType(item.LinkType)}}</el-col>
                </el-row>
                <el-row :gutter="20">
                    <el-col :span="6" class="span_l">已使用设备数：</el-col>
                    <el-col :span="16" class="span_r">{{item.UsedDeviceQuota}}</el-col>
                </el-row>
                <el-row :gutter="20">
                    <el-col :span="6" class="span_l">设备总数：</el-col>
                ...
                <el-row :gutter="20">
                    ...
                    <el-col :span="16" class="span_r">{{item.Description | formatDescription(item.Description) }}</el-col>
                </el-row>
