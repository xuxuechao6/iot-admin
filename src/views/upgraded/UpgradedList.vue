<template>
	<div>
        ...
        <el-table v-if="showList"  :data="Results" border class="table" style="width: 100%" :default-sort="{prop: 'date', order: 'descending'}">
					<el-table-column prop="Version" label="版本号"   align="center" width="110">
					</el-table-column>
					<el-table-column prop="Status" label="状态" align="center" :formatter="formatStatus" width="110">
					</el-table-column>
          <el-table-column prop="CreatedTime" label="创建时间" sortable align="center" :formatter="formatDate" width="155">
					</el-table-column>
      ...
      this.$nextTick(function() {
        ...
        formatNum: function (val, column) {
            return val.UpgradeMode == 1 ? '可选升级' : val.UpgradeMode == 2 ? '强制升级' : val.UpgradeMode == 3 ? '静默升级': '未知';
				...
				formatStatus:function(val, column){
						return val.Status == true ? '当前版本' : val.Status == false ? '历史版本' : '未知';
				},
      listView: function() {
