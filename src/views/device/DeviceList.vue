      ...
      <el-dialog title="新建设备" :visible.sync="addDevice">
        <el-form :model="addRuleForm" :rules="rules" ref="addRuleForm">
          <el-form-item label="设备序列号(SN)" prop="SN">
            <el-input v-model="addRuleForm.SN" placeholder="设备序列号最长不能超过32位"></el-input>
          </el-form-item>
          <el-form-item label="设备名称" prop="Name">
            <el-input v-model="addRuleForm.Name"></el-input>
          </el-form-item>
          <el-form-item label="MAC地址：" prop="Mac">
            <el-input v-model="addRuleForm.Mac"></el-input>
          </el-form-item>
          <el-form-item label="描述：" prop="desc">
            <el-input type="textarea" v-model="addRuleForm.desc"></el-input>
          </el-form-item>
        </el-form>
    ...
    methods: {
      ...
      submitForm(formName) {
        let self = this,
          ...
          _method = "POST",
          _body = {            //定义要传过去的参数
            'SN': self.addRuleForm.SN,
            'Name': self.addRuleForm.Name,
            'Mac': self.addRuleForm.Mac,
            'Description': self.addRuleForm.desc,
          },
