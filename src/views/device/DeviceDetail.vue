      ...
      <el-dialog class="shellCmd" :visible.sync="activeShell" size="full">
        <deviceShell :activeShell="activeShell"> </deviceShell>
			...
			<article v-if="listLoading">
				...
				<el-row :gutter="20"  v-if="isActive">
					<el-col :span="8" class="span_l">当前固件版本号：</el-col>
        ...
        <el-row :gutter="20"  v-if="isActive">
          <el-col :span="8" class="span_l">DeviceKey(激活设备)：</el-col>
          ...
          <el-row :gutter="20"  v-if="isActive">
            ...
            <span v-if="LogStatus" :span="16" class="span_r deviceLog" @click="handleOpenLog(item.DeviceId)">开启</span>
            <span v-if="!LogStatus":span="16" class="span_r deviceLog" @click="handleCloseLog(item.DeviceId)">关闭</span>
          </el-row>
