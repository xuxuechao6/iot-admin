    ...
    <div class="ms-doc">
      ...
      <article>
        ...
        <el-table v-if="showList" :data="Results" border class="table"
          ...
          <el-table-column prop="Version" label="固件版本号" align="center" width="120">
          </el-table-column>
          ...
          <el-table-column prop="IsRelease" label="是否发布" :formatter="isReleaseFormat" align="center" width="110">
          </el-table-column>
          <el-table-column  label="下载固件" :v-html="fileUrlFormat" align="center" width="120">
            <template scope="scope">
           <a :href="handleDownLoad(scope.row)" class="downLoad" :download="handleDownLoad2(scope.row)">下载</a>
    ...
    methods: {
      ...
      handleDownLoad(val) {
        let productId = sessionStorage.getItem('productId'),
          ...
          var url=val.FileUrl+"?Rtt-Sign="+sign+"&savename="+val.Name;
          console.log(url)
      return url;
      },
      handleDownLoad2(val) {
      ...
      handleDelete(val) {
        this.$confirm('此操作将永久删除该模块信息, 是否继续?', '提示', {
